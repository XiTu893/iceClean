...
本项目采用 **AGPL-3.0 + 商业授权** 双轨制：

- **个人非商业使用**：完全免费，遵循 [AGPL-3.0](LICENSE)
- **教育/科研/非营利**：完全免费，遵循 [AGPL-3.0](LICENSE)
- **商业使用**：需购买商业授权，详见 [COMMERCIAL_LICENSE.md](COMMERCIAL_LICENSE.md)

| 授权类型 | 适用范围 | 费用 |
|----------|---------|------|
| 个人使用 | 个人非商业场景 | 免费 |
| 企业标准版 | 单个法人主体使用 | ¥1,980/年 |
| 企业专业版 | 含源码、可定制 | ¥9,800/年 |
| OEM 授权 | 集成入产品分发 | 面议 |
